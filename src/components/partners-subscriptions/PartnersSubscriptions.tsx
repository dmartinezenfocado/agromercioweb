	...
	return (
		<section className="h-full mb-14 mt-7">
			<div className="w-full text-gray-700 rounded-lg m-auto max-w-homescreen h-[340px] flex flex-col">
				<h2 className="text-left text-2xl font-light text-brown-meli mb-6">
          Beneficios
				</h2>
				<div className="flex gap-4 h-64">
					...
					<div className="w-96 relative rounded-md overflow-hidden">
						...
						<img src="https://enfoco.com.do/test/apps/modulos.png" />
						<div className="absolute z-10 bottom-0 text-white flex justify-center gap-2 p-4">
							...
							<div className="text-container w-full flex flex-col text-left">
								<span>
                Estamos comprometidos con el desarrollo agricola dominicano. Capacitate total mente gratis.
								</span>
							</div>
						</div>
					</div>
					...
					<div className="w-96 relative rounded-md overflow-hidden">
						...
						<div className="absolute z-10 bottom-0 text-white flex justify-center gap-2 p-4">
							...
							<div className="text-container w-full flex flex-col text-left">
								<span>
                  Solicita préstamos, invierte y crece conectando directamente
                  con el banco agrícola.
					...
					<div className="w-96 relative rounded-md overflow-hidden">
						...
						<div className="absolute z-10 bottom-0 text-white flex justify-center gap-2 p-4">
							...
							<div className="text-container w-full flex flex-col text-left">
								<span>
                  Actualízate con las últimas noticias referentes a la
                  agricultura
								</span>
							</div>
						</div>
