		...
		<>
			<div className="flexjustify-between px-16 py-10 flex flex-col gap-10">
				<div className="flex justify-between">
					<span className="text-2xl font-bold">Comprá con Agro Crédito ¡Tenés hasta 12 cuotas sin tarjeta!</span>
				...
				<div className='modal-body flex flex-col gap-5 font-normal text-sm'>
					<ol className='list-decimal flex flex-col gap-4'>
						...
						<li><span className='font-semibold'>Seleccioná Agro Crédito como medio de pago</span> y la cantidad de cuotas.</li>
						<li><span className='font-semibold'>Pagá las cuotas mes a mes</span> con débito, efectivo o dinero en cuenta desde la sección Agro Crédito.</li>
					</ol>
				</div>
			</div>
		</>
