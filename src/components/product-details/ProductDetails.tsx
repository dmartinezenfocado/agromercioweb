...
export const ProductDetails = () => {
	...
	const [selectedImage] = useState(selectedProduct.pictures[0])
	// const [selectedImageSize] = useState(selectedProduct.pictures[0].size)
	// const productCondition = selectedProduct.attributes.find((attr: {id:string}) => attr.id === 'ITEM_CONDITION').value_name
	const productCondition = 'Excelente calidad'
